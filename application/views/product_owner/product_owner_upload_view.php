          ...
          <!-- general form elements -->
            ...
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <a type="button" class="btn btn-info" href="<?php echo base_url() ?>uploads/excel/201707/product_tos_template.xlsx"><i class="ion ion-ios-cloud-download-outline"></i> Template</a>
                </div><!-- /.box-header -->
                <!-- form start -->
