          ...
          <!-- general form elements -->
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">  View info Product vendors : (<?php echo $product_vendor_data['product_vendor_id']; ?>)</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                      ...
                      <div class="row">
                          <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="model"  name="model" value="<?php echo $product_vendor_data['model']; ?>"  maxlength="64"  required="true" readonly="true">
                              </div>
                          </div>
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="description"  name="description" value="<?php echo $product_vendor_data['description']; ?>" maxlength="1204" readonly>
                                </div>
                            </div>
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control required" id="dealer_price" name="dealer_price" value="<?php echo $product_vendor_data['dealer_price']; ?>"maxlength="10" readonly="true">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control required" id="name" name="name" value="<?php echo $product_vendor_data['create_by_name']; ?>" maxlength="128" readonly>
                                    <input type="hidden" value="<?php echo $product_vendor_data['product_vendor_id']; ?>" name="product_vendor_id" id="product_vendor_id" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="description"  name="description" value="<?php echo $product_vendor_data['create_date']; ?>" maxlength="1204" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control required" id="name" name="name" value="<?php echo $product_vendor_data['modified_by_name']; ?>" maxlength="128" readonly>
                                    <input type="hidden" value="<?php echo $product_vendor_data['product_vendor_id']; ?>" name="product_vendor_id" id="product_vendor_id" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="description"  name="description" value="<?php echo $product_vendor_data['modified_date']; ?>" maxlength="1204" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
