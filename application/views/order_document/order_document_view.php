              ...
              <div class="box-body table-responsive no-padding">
                <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-sm btn-info" href="<?php echo base_url().'order_document_internal/edit/'.$record->order_document_id; ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                      </td>
                    </tr>
                    <?php endforeach; ?>
                  </table>
