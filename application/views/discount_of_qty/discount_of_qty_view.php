          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                  <h3 class="box-title">QTY List</h3>
                  <div class="box-tools">
                      <form action="<?php echo base_url() ?>discount_of_qty" method="POST" id="searchList">
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                          <a class="btn btn-sm btn-warning" href="<?php echo base_url().'discount_of_qty/edit/'.$record->discount_of_qty_id; ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                          <a class="btn btn-sm btn-info" href="<?php echo base_url().'discount_of_qty/view/'.$record->discount_of_qty_id; ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
                      </td>
                    </tr>
                    <?php endforeach; ?>
                  </table>
