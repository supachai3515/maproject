        ...
        <div class="box">
          ...
          <div class="box-body">
            <div class="row text-center">
              <?php if ($max_qo == 0): ?>
                <a class="btn btn-primary" href="<?php echo base_url('quotation/add/'.$orders_data['order_id']) ?>"><i class="fa fa-file-text-o" aria-hidden="true"></i>  ออกใบเสนอราคา</a>
              <?php else: ?>
                <a class="btn btn-primary" href="<?php echo base_url('quotation/edit/'.$max_qo) ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>  แก้ไขใบเสนอราคา</a>
              <?php endif ?>
            </div>
          </div><!-- /.box-body -->
        </div><!-- /.box -->
