              ...
              <div class="box-body table-responsive no-padding">
                <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                          <a class="btn btn-sm btn-warning" href="<?php echo base_url().'orders_sale/edit/'.$record->order_id; ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                          <a class="btn btn-sm btn-info" href="<?php echo base_url().'orders_sale/view/'.$record->order_id; ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
                      </td>
                    </tr>
                    <?php endforeach; ?>
                  </table>
