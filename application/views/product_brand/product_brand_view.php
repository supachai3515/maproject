          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                  ...
                  <div class="box-tools">
                      <form action="<?php echo base_url() ?>product_brand" method="POST" id="searchList">
              ...
              <div class="box-body table-responsive no-padding">
                <table class="table table-hover">
                    ...
                    <?php foreach ($product_brand_list as $record): ?>
                    <tr>
                      ...
                      <td class="text-center">
                          <a class="btn btn-sm btn-warning" href="<?php echo base_url().'product_brand/edit/'.$record->product_brand_id; ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                          <a class="btn btn-sm btn-info" href="<?php echo base_url().'product_brand/view/'.$record->product_brand_id; ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
                      </td>
                    </tr>
                    <?php endforeach; ?>
                  </table>
