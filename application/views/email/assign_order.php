												...
												<tr>
													<td style="padding:17px 3.358% 15px">
														<cite style="text-align:center;display:block;font-style:normal">
															<span style="font-size:1px;min-height:0;color:#fff;width:0;display:block">Assign order to sale</span>
															<dl style="list-style-type:none;padding:0;overflow:hidden;margin:0">
																<dt style="font-size:15px;display:inline-block;width:100%;margin:0;padding:0 0 12px 0;vertical-align:top;padding-bottom:0!important">
																	<a href="<?php echo base_url(); ?>" title="<?php echo $this->config->item('sitename'); ?>" style="display:inline-block" target="_blank"><?php echo $this->config->item('sitename'); ?></a>
                                  <p><strong>Assign by</strong> : <?php echo $user_data_assign['name'];?></p>
                                  <p><strong>Assign to</strong> : <?php echo $user_data_assign_to['name']; ?></p>
