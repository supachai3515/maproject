													...
													<tr>
														<td style="padding:17px 3.358% 15px">
															...
															<dl style="list-style-type:none;padding:0;overflow:hidden;margin:0">
																...
																<a href="<?php echo base_url(); ?>" title="TOS" style="display:inline-block" target="_blank">TOS</a>
																</dt>
														...
														<td style="font-size:15px;color:#555;line-height:24px">
															<div style="border-top:3px solid #3c8dbc;position: relative;border-radius: 3px;background: #ffffff;margin-bottom: 20px;width: 100%;">
																<div style="color: #444;display: block;padding: 10px;position: relative;border-bottom: 1px solid #f4f4f4;">
																	<p style="display: inline-block;font-size: 18px;margin: 0;line-height: 1;">Sale Info</p>
																</div>
																<div style="border-top-left-radius: 0;border-top-right-radius: 0;border-bottom-right-radius: 3px;border-bottom-left-radius: 3px;padding: 10px;">
																	<div style="overflow: hidden;">
																		<p style="margin-bottom: 0;text-align: right;width: 41.66666667%;float: left;margin-right: 10px;font-weight: bold;">Name:</p>
																		<div style="float: left;">
																			<p style="padding-bottom: 7px;margin-bottom: 0;"><?php echo $sale_detail['name']; ?></p>
																		</div>
																	</div>
																	<div style="overflow: hidden;">
																		<p style="margin-bottom: 0;text-align: right;width: 41.66666667%;float: left;margin-right: 10px;font-weight: bold;">Email:</p>
																		<div style="float: left;">
																			<p style="padding-bottom: 7px;margin-bottom: 0;"><a href="mailto:<?php echo $sale_detail['email']; ?>"><?php echo $sale_detail['email']; ?></a></p>
																		</div>
																	</div>
																	<div style="overflow: hidden;">
																		<p style="margin-bottom: 0;text-align: right;width: 41.66666667%;float: left;margin-right: 10px;font-weight: bold;">Tel:</p>
																		<div style="float: left;">
																			<p style="padding-bottom: 7px;margin-bottom: 0;"><?php echo $sale_detail['tel']; ?></p>
																		</div>
																	</div>
																</div>
															</div>
															...
															<div style="border-top:3px solid #3c8dbc;position: relative;border-radius: 3px;background: #ffffff;margin-bottom: 20px;width: 100%;">
																...
																<?php endforeach; ?>
																<p>ระบบได้ทำการปรับราคาสินค้า ตามที่ท่านได้ขอราคาพิเศษมาแล้ว <a href="<?php echo base_url(); ?>tos_cal/special_price/<?php echo $order_data['ref_id']; ?>" target="_blank">คลิกที่นี้</a> เพื่อยืนยันการสั่งซื้อ</p>
															</div>
														</div>
													</td>
												</tr>
